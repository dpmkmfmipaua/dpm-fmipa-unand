...
const DEMISIONER = [
  ...
  {
    periode: "2023/2024",
    namaParlemen: "Parlemen Equilibrium",
    pengurusInti: [
      { nama: "Muhammad Fajrul Rahman", jabatan: "Ketua Umum" },
      { nama: "Vira Adri Yeni", jabatan: "Wakil Ketua I" },
      { nama: "Gustrifa", jabatan: "Wakil Ketua II" },
      { nama: "Widia Fitri", jabatan: "Ketua Komisi I" },
      { nama: "Fadillatul Aziza", jabatan: "Ketua Komisi II" },
      { nama: "Titania Riadhatil Qolbi", jabatan: "Komisi III" },
      { nama: "Zahra Aulia Putri", jabatan: "Biro Infokom" },
      { nama: "-", jabatan: "Biro Administrasi" },
    ],
  },
  {
    periode: "2022/2023",
    namaParlemen: "Parlemen Quark",
    pengurusInti: [
      { nama: "Sintya Wulandari", jabatan: "Ketua Umum" },
      { nama: "-", jabatan: "Wakil Ketua 1" },
      { nama: "-", jabatan: "Wakil Ketua 2" },
      { nama: "-", jabatan: "Ketua Komisi I" },
      { nama: "-", jabatan: "Ketua Komisi II" },
      { nama: "-", jabatan: "Ketua Komisi III" },
      { nama: "-", jabatan: "Kepala Biro Administrasi" },
      { nama: "-", jabatan: "Kepala Biro Infokom" },
    ],
  },
  {
    periode: "2021/2022",
    namaParlemen: "Parlemen Axis",
    pengurusInti: [
      { nama: "Royhan Sauqi", jabatan: "Ketua" },
      { nama: "Ahmad Fakhri", jabatan: "Wakil Ketua 1" },
      { nama: "Halimah Tusa'diyah Z", jabatan: "Wakil Ketua 2" },
      { nama: "Hanif Rayhan Riyandi", jabatan: "Kepala Badan Kehormatan" },
      { nama: "Nadira Nurul Fathiyah", jabatan: "Ketua Komisi 1" },
      { nama: "Arika Prasejati", jabatan: "Ketua Komisi II" },
      { nama: "Hanifah Aulia Nabila", jabatan: "Ketua Komisi III" },
      { nama: "Yosin Rasyidayasu", jabatan: "Ketua Biro ADM" },
